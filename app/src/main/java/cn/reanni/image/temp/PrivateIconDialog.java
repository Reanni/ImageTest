...
public class PrivateIconDialog extends BottomDialog implements View.OnClickListener {
    ToolsActivity activity;


    public PrivateIconDialog(@NonNull Context context, File cameraTempFile) {
        super(context);
        this.activity = (ToolsActivity) context;
        this.cameraTempFile = cameraTempFile;
    }

/*    public PrivateIconDialog(@NonNull Context context) {
        super(context);
        this.activity = (DetailForPrivateActivity) context;
    }

    public PrivateIconDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected PrivateIconDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
